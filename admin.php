...
<html>
  ...
  Limit script execution time to: <input type="text" name="timelimit" maxlength="3" size="3" value="<?php echo $timelimit; ?>" disabled="disabled"> seconds (enter 0 for no limit, but note that doing so is potentially VERY dangerous)<br>
  ...
  <a name="save"></a><input type="submit" value="Save changes"><input type="button" value="Undo changes" onclick="window.location.href='admin.php'"><input type="button" value="Exit console" onclick="window.location.href='index.php'">
  </form>
  </body>
</html>