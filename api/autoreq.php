<?php	
	...
	//If password verify function not defined, define it
			...
			if($key != "" && isset($_POST['key']) && password_verify($_POST['key'],$key))
			{
				...
				if(count($rawposts) > 0)
				{
					...
					foreach($rawposts as $post)
					{
						...
						//Add appropriate details to the array
						$details[]=$contents[0];
						$details[]=$contents[1];
						$details[]=$contents[3];
						$details[]=$contents[4];
						...
						$details[]=$contents[5][0];
						if(isset($contents[6]) && trim($contents[6]) != "")
						{
							$details[]=$contents[6];
						}
						else
						...
						if($contents[5][1] != "None")
						{
							$details[]=$contents[5][1];
						}
						else
						{
							$details[]="None";
